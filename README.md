...
Open Postman
Click Import
Select Mechanic_Shop_API.postman_collection.json
Run Login first, then copy the returned auth_token into the collection's auth_token variable to use the protected routes
Notes
